// --------------------------------------------------------------------------------------
// Builds the documentation from `.fsx` and `.md` files in the 'docsrc/posts' directory
...
let githubLink = "https://github.com/HLWeil/CSBlog"

// Specify more information about your project
let info =
  [ "project-name", "CSBlog"
    "project-author", "HLWeil"
...
let copyFiles () =
  ...
  CopyRecursive (styles) (output @@ "content") true 
